...
public class JRedisUtil {
    ...
    private static class RedisService {
        private static JRedisUtil redis = new JRedisUtil("148.70.12.158", 6379);
    }
    ...
    private JRedisUtil() {
        if (pool == null) {
            ...
            config.setMaxWaitMillis(1000 * 100);
            config.setTestOnBorrow(true);
            pool = new JedisPool(config, "148.70.12.158", 6379, 100000);
        }
    }
    ...
    public static void main(String[] args) {
        JRedisUtil redisutil = new JRedisUtil("148.70.12.158", 6379);

        redisutil.hset("123", "abc", "1111");
